...
const AboutPage = () => {
    return (
        <div className="grow mt-8">
            <h1 className="text-xl font-semibold mb-6">Meow-velous Greetings, Admirers of the Extraordinary!</h1>
            ...
            <h1 className="text-lg font-semibold mb-4">Editor&apos;s Notes</h1>
            <p className="text-justify">
